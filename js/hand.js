...
// Hand sorting code, mostly rewritten from xorhash's original
...
function updateOutput(e, ui) {
    ...
    $('#cards-grid').children('.hand-card').each(function() {
        ...
        if(13 + cardIDStrings[currStr].length + sortNumStrings[currStr].length + cardid.toString().length + sortval.toString().length > 400) {
            currStr++;
